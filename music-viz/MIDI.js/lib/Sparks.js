...
SPARKS.Emitter = function (counter) {
    ...
    this._emitcounter = this._counter = counter ? counter : new SPARKS.SteadyCounter(10); // provides number of particles to produce
    this._noemitcounter = new SPARKS.SteadyCounter(0);
...
SPARKS.Emitter.prototype = {
	...
	this._counter = this._emitcounter;
	if(!this.isRunning())
	    this.start();
    },

    stopEmitting: function() {
	this._counter = this._noemitcounter;
    },
