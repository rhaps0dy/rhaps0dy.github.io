...
/*        document.body.appendChild(canvas);
    ...
    var camera, scene, attributes, sparksEmitter, stats, emitters, analyser, renderer, delta = 1, windowHalfX, windowHalfY, heightTex, waveformTex, heightMap, waveform, group, rotXGroup, beat_color;
    function init() {
        ...
        for(var i=0; i<BUFFER_SIZE; i++) waveform[i] = 0;
    ...
    var tdomain = new Float32Array(BUFFER_SIZE);
    function render() {
	...
	beat_color.b *= 0.9;
        if(!lastWasBeat && diff > 0.1) {
            ...
            beat_color.setHSL(Math.random(), 1, 0.5);
